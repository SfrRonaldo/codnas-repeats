      ...
      <div id="results">
        <div className="pt-24 space-y-4">
          ...
          <p className="text-sm sm:text-base text-justify">
            ...
            the data collected from the search in the CoDNaS-Repeats database of the conformational diversity
            information of the repeated protein chain entered. The sections displayed in the Detail window are described
            below.
          </p>
          ...
          <p className="text-sm sm:text-base text-justify">
            ...
            evidence on the conformational diversity of the repeat protein. In addition, the minimum, maximum and
